...
public class IfElseNest2 {
    ...
    int d = 400;
//Nested if else
    if(a>b && b>c && c>d){ //false then will not print SOP and go to next else
        System.out.println("a is greates");
    }   else if(b>c && c>d){ // false
        System.out.println("b is greatest");
    }   else if (c>d) { //false
        System.out.println("c is greatest");
    }   else {  //Here we dont write anything in () because we have compare a to b, b to c,
